...
<body>
    ...
    <main class="container">
        ...
        <form action="manicure-cadastro.php" method="POST" class="formulario">
            ...
            <input type="text" id="cpf_cnpj" name="cpf_cnpj" placeholder="00.000.000/0000-00 ou 000.000.000-00" required>

            <label for="cep">CEP</label>
            <input type="text" id="cep" name="cep" placeholder="00000-000" pattern="\d{5}-?\d{3}" required>

            <label for="telefone">Telefone</label>
            <input type="text" id="telefone" name="telefone" placeholder="(00)00000-000" pattern="\(\d{2}\)\s?\d{4,5}-\d{4}" required>
